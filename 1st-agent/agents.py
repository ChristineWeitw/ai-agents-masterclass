...
# tool - a function that creates a task in Asana
...
# list of tools that the AI can use
def get_tools():
    tools = [
        {
            "type": "function",
...
# Function to prompt the AI and handle tool calls
def prompt_ai(messages):
    ...
    if tool_calls:
        ...
        print(f"[DEBUG] second_response.content:\n{second_response.choices[0].message}\n")
